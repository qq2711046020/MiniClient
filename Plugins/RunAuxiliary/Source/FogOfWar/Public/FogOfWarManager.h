...
public:
	...
	void RegisterStaticUnfogged(FVector InLocation, float InRadius);
	
	void GetStaticUnfogged(TArray<FFOWStaticModifier_UnFogged>& OutUnFogged);
public:
	TArray<FFOWStaticModifier_UnFogged> StaticModifier;
	uint8 bIsNeedUpdate : 1;
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = FogOfWar)
	//uint8 bInverseTransformInStreaming : 1;
